...
public class TopDealDetailActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void alert() {
        final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(TopDealDetailActivity.this);
        alertDialogBuilder
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.sorting_list:
                ...
                PopupMenu popup = new PopupMenu(TopDealDetailActivity.this, sorting_list);
                popup.getMenuInflater().inflate(R.menu.category_sortings_list, popup.getMenu());


                if (cc.loadPrefString("td_order").equals("DESC") && cc.loadPrefString("td_name").equals("rating")) {
...
//                        String name = "rating";
                ...
                } else if (cc.loadPrefString("td_order").equals("DESC") && cc.loadPrefString("td_name").equals("model")) {
...
//                        String name = "model";
                ...
                } else if (cc.loadPrefString("td_order").equals("ASC") && cc.loadPrefString("td_name").equals("model")) {
...
//                        String name = "model";
                ...
                } else if (cc.loadPrefString("td_order").equals("ASC") && cc.loadPrefString("td_name").equals("rating")) {
...
//                        String name = "rating";
                ...
                } else if (cc.loadPrefString("td_order").equals("ASC") && cc.loadPrefString("td_name").equals("price")) {
...
//                        String name = "price";
                ...
                } else if (cc.loadPrefString("td_order").equals("DESC") && cc.loadPrefString("td_name").equals("price")) {
...
//                        String name = "price";
                ...
                } else if (cc.loadPrefString("td_order").equals("DESC") && cc.loadPrefString("td_name").equals("name")) {
...
//                        String name = "name";
                ...
                } else if (cc.loadPrefString("td_order").equals("ASC") && cc.loadPrefString("td_name").equals("name")) {
...
//                        String name = "name";
                        ...
                        switch (item.getItemId()) {
                            ...
                            case R.id.defult:
                                ...
                                if (item.isChecked()) {
                                    ...
                                    String name = "name";
                                    cc.savePrefString("td_order", order);
                                    cc.savePrefString("td_name", name);
                                    if (!cc.isConnectingToInternet()) {
            ...
            case R.id.ln_home_bottom:
                ...
                Intent intentMainActivity = new Intent(TopDealDetailActivity.this, MainActivity.class);
            ...
            case R.id.ln_category_bottom:
                ...
                Intent intentShopCategory = new Intent(TopDealDetailActivity.this, ShopCategoryActivity.class);
            ...
            case R.id.ln_mycc_bottom:
                ...
                if (cc.loadPrefBoolean("isLogin") == true) {
                    ...
                    Intent intentMyAccount = new Intent(TopDealDetailActivity.this, MyAccountActivity.class);
            ...
            case R.id.ln_wishlist_bottom:
                ...
                Intent intentWishList = new Intent(TopDealDetailActivity.this, WishlistActivity.class);
...
//
//                Intent intentDeal = new Intent(TopDealDetailActivity.this, DealActivity.class);
...
//                break;
    ...
    private void categoryDetailWS() {
        ...
        pDialog = new ProgressDialog(TopDealDetailActivity.this);
        ...
        StringRequest jsonObjReq = new StringRequest(Request.Method.POST, ConnectionUrl.get_topdeal,
                new Response.Listener<String>() {

                    @Override
                    public void onResponse(String response) {
                        Log.e("response:topdealdata", response);
                        ...
                        try {
                            ...
                            if (topDealDatas.size() > 0) {
                                ...
                                mAdapter = new TopDealsListingAdapter(TopDealDetailActivity.this, topDealDatas);
                                recycleview_listing_items.setAdapter(mAdapter);
                                TopDealGridListingAdapter adapter = new TopDealGridListingAdapter(TopDealDetailActivity.this, topDealDatas);
...
//                Log.i("categorydetail_cookies", rawCookies);
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                map.put("order", cc.loadPrefString("td_order"));
                map.put("sort", cc.loadPrefString("td_name"));
//                map.put("path", finalcategoryid);
    ...
    public class TopDealsListingAdapter extends RecyclerView.Adapter<TopDealsListingAdapter.ViewHolder> {
        ...
        public TopDealsListingAdapter(TopDealDetailActivity categoryDetailActivity, List<TopDealData> categoryListingdataList) {
...
//                    Log.i("addwishlist_cookies", rawCookies);
        ...
        public void onBindViewHolder(final ViewHolder viewHolder, final int i) {
            ...
            TopDealData cc = categoryListingdatas.get(i);


            if (categoryListingdatas.get(i).isIswishlist()) {
            ...
            viewHolder.tv_offer_price.setText(categoryListingdatas.get(i).getSpecial());
            ...
            viewHolder.img_wishlist.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (categoryListingdatas.get(i).isIswishlist()) {
                        categoryListingdatas.get(i).setIswishlist(false);
                        viewHolder.img_wishlist.setImageResource(R.mipmap.faviourite);
                    } else {
                        categoryListingdatas.get(i).setIswishlist(true);
                        viewHolder.img_wishlist.setImageResource(R.mipmap.nav_wish);
                    }
//                    notifyItemChanged(position);

                    getPositionItem(i, categoryListingdatas.get(i).isIswishlist());
            ...
            viewHolder.img_share.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    TopDealData rm = categoryListingdatas.get(i);
            ...
            if (categoryListingdatas.size() != 0) {
                Picasso.with(mContext).load(categoryListingdatas.get(i).getImageUrl()).into(viewHolder.imgThumbnail, new Callback() {
                    @Override
        ...
        private void getPositionItem1(int adapterPosition) {
            ...
            TopDealData nm = categoryListingdatas.get(adapterPosition);
            nm.getProductid();
...
//            cc.savePrefString("productid", String.valueOf(rm.getProductid()));
            ...
            if (tokens.isEmpty()) {
                Log.e("Token", "Empty");
                TopDealData rm = categoryListingdatas.get(adapterPosition);
